                ...
                public void onPremioLoaded(Premio premio) {
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            Canje caneje = new Canje(sharedPreferences.getInt("idUsuario", -1),intent.getIntExtra("idPremio", -1),intent.getIntExtra("idPuntoVerde", -1),1,intent.getIntExtra("Precio", -1),false);
