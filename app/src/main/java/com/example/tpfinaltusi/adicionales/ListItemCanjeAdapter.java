...
public class ListItemCanjeAdapter extends ArrayAdapter<Canje> {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(filtro == 1){
            Llenar_view(position, convertView, parent);
        }
        else if(filtro == 2){
            Llenar_view_filter(position, convertView, parent,false);

        }
        else if(filtro == 3){
            Llenar_view_filter(position, convertView, parent,true);
        }
    ...
    void Llenar_view(final int position, View convertView, ViewGroup parent){
    ...
    void Llenar_view_filter(final int position, View convertView, ViewGroup parent, boolean estado){
        // Obtener una instancia del Producto en la posición actual
        Canje canje = getItem(position);
